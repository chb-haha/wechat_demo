...
import com.example.wechat.utils.HttpClientUtil;
...
public class WeChatController {
    ...
    public String GETTOKEN = "" +
            "https://api.weixin.qq.com/sns/oauth2/access_token?appid=wx7287a60bb700fd21&secret=1ef8755f92bebae8ad7bab432ba29cbf&code=CODE&grant_type=authorization_code";
     ...
     */
    @GetMapping("/callBack")
    public ModelAndView callBack(@RequestParam(value = "code",required = true)String code, String state){
